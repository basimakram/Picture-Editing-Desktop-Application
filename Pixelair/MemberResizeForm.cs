...
namespace Pixelair
{
    public partial class MemberResizeForm : Form
    {
        SoundPlayer s;

        public MemberResizeForm()
        {
            InitializeComponent();
            button8.Visible = false;
            s = new SoundPlayer(@"C:\PATH TO AUDIO\Pixelair\Media\beth_thornton_something_you_don_t_know.wav");
            s.PlayLooping();
        }
