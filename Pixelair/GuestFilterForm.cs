...
namespace Pixelair
{
    public partial class GuestFilterForm : Form
    {
        SoundPlayer s;
        public GuestFilterForm()
        {
            InitializeComponent();
        ...
        {
            Guest_Entry me = new Guest_Entry();
            me.Show();
            this.Hide();
        }
        ...
        {
            MessageBox.Show("This Filter is Locked. Please SignUp to access all the Filters");
        }
